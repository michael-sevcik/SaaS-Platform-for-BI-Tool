...
export function loadDevelopmentView(): number {
    ...
    const sourceTable1 = new SourceTable(table1.name, null,  table1.columns.map(c => new SourceColumn(c)));
    const sourceTable2 = new SourceTable(table2.name, null, table2.columns.map(c => new SourceColumn(c)));
